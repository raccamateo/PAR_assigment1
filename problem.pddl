(define (problem cleaning-test-case-1)
  ...
  (:init
    (robot-location o4)
    (box-location boxA o1)  ; Box A is in o1
    (clean o1) (clean o2) (dirty o3) (dirty o4) (clean o5) (dirty o6) (dirty o7) (dirty o8) (clean o9)
    (empty o2) (empty o3) (empty o4) (empty o5) (empty o6) (empty o7) (empty o8) (empty o9) ; rooms without boxes
    ; Adjacent relations 
